window.VMI18n = (() => {
  const messages = {
    fr: {
      ...
      'onboarding.goalsTitle':'Quels sont vos objectifs ?',
      'onboarding.lockTitle':'Protéger l’application ?',
      'onboarding.lockYes':'Oui',
      'onboarding.lockNo':'Non',
      'onboarding.targetWeight':'Poids visé (kg)',
      ...
      'onboarding.pinConfirm':'Confirmer le code',
    ...
    en: {
      ...
      'onboarding.eyebrow':'Welcome','onboarding.title':'Let’s create your wellness space','onboarding.name':'First name','onboarding.age':'Age','onboarding.sex':'Sex','onboarding.goal':'Main goal','onboarding.goalsTitle':'What are your goals?','onboarding.lockTitle':'Protect the app?','onboarding.lockYes':'Yes','onboarding.lockNo':'No','onboarding.height':'Height (cm)','onboarding.weight':'Current weight (kg)','onboarding.targetWeight':'Target weight (kg)','onboarding.why':'Why do you want to move forward?','onboarding.pin':'App code',
      'onboarding.pinConfirm':'Confirm code','onboarding.question':'Recovery question','onboarding.answer':'Recovery answer','onboarding.save':'Create my space',
      'goals.confidence':'Build my confidence','goals.health':'Improve my health','goals.energy':'Have more energy','goals.wellbeing':'Overall wellbeing','goals.body':'Feel better in my body','goals.habit':'Build better habits',
